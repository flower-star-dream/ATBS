...
@ConditionalOnSpel("'${spring.application.name:}' != 'auth-service' && '${spring.application.name:}' != 'user-service'")
public interface GlobalAuthClient extends IUserResolveService {
